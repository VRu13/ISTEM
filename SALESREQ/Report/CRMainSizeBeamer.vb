...
Public Class CRMainSizeBeamer
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.CRMainSizeBeamer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRMainSizeBeamer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRMainSizeBeamer = New CRMainSizeBeamer()
        rpt.Site = Me.Site
        Return rpt
    End Function
