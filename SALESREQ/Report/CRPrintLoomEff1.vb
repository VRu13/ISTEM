...
Public Class CRPrintLoomEff1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.CRPrintLoomEff1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPrintLoomEff1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPrintLoomEff1 = New CRPrintLoomEff1()
        rpt.Site = Me.Site
        Return rpt
    End Function
