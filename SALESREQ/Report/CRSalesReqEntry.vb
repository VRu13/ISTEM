...
Public Class CRSalesReqEntry
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.CRSalesReqEntry.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRSalesReqEntry
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRSalesReqEntry = New CRSalesReqEntry()
        rpt.Site = Me.Site
        Return rpt
    End Function
