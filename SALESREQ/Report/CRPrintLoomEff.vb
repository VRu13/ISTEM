...
Public Class CRPrintLoomEff
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.CRPrintLoomEff.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPrintLoomEff
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPrintLoomEff = New CRPrintLoomEff()
        rpt.Site = Me.Site
        Return rpt
    End Function
