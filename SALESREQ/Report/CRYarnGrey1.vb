...
Public Class CRYarnGrey1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.CRYarnGrey1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRYarnGrey1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRYarnGrey1 = New CRYarnGrey1()
        rpt.Site = Me.Site
        Return rpt
    End Function
